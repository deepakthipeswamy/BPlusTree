...
class BTDriver implements GlobalConst {
	...
	private void menu() {
		...
		System.out.println("\n[3]   Insert a Record");
		System.out.println("[4]   Delete a Record (Full Delete)");
		System.out.println("[5]   Delete some records (Full Delete)");
	...
	protected void runAllTests() {
		...
		try {
			System.out.println(" ***************** The file name is: " + "AAA"
					+ postfix + "  **********");
			file = new BTreeFile("AAA" + postfix, keyType, 4, deleteFashion);// full
																				// delete
		} catch (Exception e) {
			e.printStackTrace();
			return;
